...
export default function BalanceTab({ onTabChange }: Props) {
  return (
    <div className="flex flex-col gap-5 animate-fade-in pb-4">
      ...
      <div className="relative overflow-hidden rounded-2xl p-6" style={{
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-2 mt-1">
            <span className="text-sm" style={{ color: "rgba(255,255,255,0.4)" }}>≈ 2,200.5 TON</span>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="text-xs font-medium" style={{ color: "#00D4FF" }}>Все токены</button>
        </div>
          ...
          {tokens.map((token, i) => (
            ...
            >
              ...
              <div className="text-right">
                <div className="text-sm font-semibold font-mono-wallet" style={{ color: "#fff" }}>{token.usd}</div>
